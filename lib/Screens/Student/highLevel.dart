...
import 'begining.dart';
import 'midLevel.dart';
import 'primary.dart';
import 'studentClass.dart';

class HighLevelScreen extends StatelessWidget {
  const HighLevelScreen({super.key});
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          navigateTo(context, PrimaryLevel());
                                        },
                                        child: Container(
                                ...
                                Column(
                                  children: [
                                    Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          navigateTo(context, BeginingLevel());
                                        },
                                        child: Container(
                                            // autogrouprb27UbZ (CaiJx2aAA1LjyS8LBErB27)
                                            margin:
                                    ...
                                    Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          navigateTo(context, MidLevelScreen());
                                        },
                                        child: Container(
                                            // autogrouprb27UbZ (CaiJx2aAA1LjyS8LBErB27)
                                            margin:
                            ...
                            child: Column(children: [
                              ...
                              Column(
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      navigateTo(context, StudentClassScreen());
                                    },
                                    child: Container(
                                      width: double.infinity,
                                      // autogrouprb27UbZ (CaiJx2aAA1LjyS8LBErB27)
